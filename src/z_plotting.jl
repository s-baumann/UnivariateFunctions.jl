...
function plot(fun::Union{Vector{UnivariateFunction},Vector{Undefined_Function}, Vector{PE_Function}, Vector{Sum_Of_Functions}, Vector{Piecewise_Function}}, left::Real = 0.0, right::Real = 1.0)
...
function plot(fun::Dict{ss,tt}, left::Real = 0.0, right::Real = 1.0) where ss<:Union{Symbol,Integer,String} where tt<:Union{UnivariateFunction,Undefined_Function, PE_Function, Sum_Of_Functions, Piecewise_Function}
    X = convert(Array{Float64,1}, left:0.01:right)
