...
using Dates, TimeZones, SchumakerSpline, GLM, DataFrames, MultivariateStats, NonNegLeastSquares, VegaLite, UUIDs, Random, Statistics, StatsBase
...
export UnivariateFitter, UnivariateAdjustedFitter, fit!, simplify
